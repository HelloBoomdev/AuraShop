      ...
      <ScrollView>
        <View className="p-4">
          ...
          <View className="items-center mb-6 mt-5">
            <Image
              source={{ uri: 'https://scontent.fbkk4-3.fna.fbcdn.net/v/t39.30808-1/361223952_943368633431889_3055263234919610598_n.jpg?stp=dst-jpg_s200x200_tt6&_nc_cat=106&ccb=1-7&_nc_sid=e99d92&_nc_eui2=AeFskpnDHrZGqbRH4BTo0dDNWOta2RBTtOdY61rZEFO058LzKnQD_ds49gCKfN_nmpvncmFOnSoOO-4P_Ou08d_-&_nc_ohc=sLkwUANQTVEQ7kNvgEfL5qM&_nc_oc=AdhfeKp6uQAo0DdNuQXEIURqDEeVMy5KgyneuJXDcDZRK_3JX-fM14VIHPyFeCAfZBY&_nc_zt=24&_nc_ht=scontent.fbkk4-3.fna&_nc_gid=Aq_LXlt3d0Z2Ka6K_vCk4Q&oh=00_AYG3tY00mt_fgLguycLjeQG-xF9zFnSf42ihnoXAAZdzew&oe=67DECC97' }}
              className="w-20 h-20 rounded-full"
            />
            <Text className="text-3xl mt-5" fontWeight='medium'>นาวิน สุธรรมชัย</Text>
